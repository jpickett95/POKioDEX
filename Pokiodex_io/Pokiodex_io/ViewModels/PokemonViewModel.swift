...
//    }
    ...
    func returnTypeRelations(typeName: String) -> TypeRelations {
        var typeRelations = TypeRelations(no_damage_to: [TypeRelationsType](), half_damage_to: [TypeRelationsType](), double_damage_to: [TypeRelationsType](), no_damage_from: [TypeRelationsType](), half_damage_from: [TypeRelationsType](), double_damage_from: [TypeRelationsType]())
